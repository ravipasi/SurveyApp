namespace AnalyticaDocs.Util
{
    public abstract class DBConnection
    {
        // 🔐 Hardcoded string — suitable for isolated environments
         private static readonly string cs = "Server=182.19.5.165;Database=VLDev;UID=adminrole;Password=@dminr0le;Connect Timeout=360000;TrustServerCertificate=True";
        //private static readonly string cs = "Server=182.19.5.165;Database=VLDev;UID=adminrole;Password=@dminr0le;Connect Timeout=360000;TrustServerCertificate=True";
